...
- ✨ I am passionate about **programming**. My favourite programming languages are **JavaScript** and **Python**, but I also have experience with **other languages** and am always eager to explore new technologies and expand my skills.
...
- I am passionate about **NVIDIA GPU programming** with **CUDA**, leveraging parallel computing to optimize performance and accelerate complex tasks.
